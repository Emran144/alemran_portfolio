export const personal = {
  ...
  title: "Senior ML Engineer & ML Team Lead",
  tagline:
    "Building production-grade AI systems at the intersection of GenAI, Document Intelligence, and Applied ML.",
  ...
  researchInterests:
    "Multimodal ML, DocumentAI, Generative AI, Agentic AI, AI for Health & Education.",
  stats: [
