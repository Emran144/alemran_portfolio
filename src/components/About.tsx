        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: "3rem", alignItems: "start" }}>
          <div>
            ...
            <aside aria-label="Research interests" style={{ padding: "1rem 1.25rem", borderRadius: "0.75rem", backgroundColor: "var(--bg-card)", border: "1px solid var(--border)" }}>
              ...
              <p style={{ color: "var(--text-muted)", fontSize: "0.875rem", lineHeight: 1.7 }}>{personal.researchInterests}</p>
            </aside>
          </div>
          ...
          <div>
            ...
            <ol style={{ listStyle: "none", margin: 0, padding: 0, display: "flex", flexDirection: "column", gap: "1.25rem" }}>
              {education.map((edu) => (
                <li key={edu.id}
                  style={{ padding: "1.25rem", borderRadius: "0.875rem", backgroundColor: "var(--bg-card)", border: "1px solid var(--border)", transition: "border-color 0.2s" }}
